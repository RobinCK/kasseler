...
<table width="100%" cellspacing="2" cellpadding="2">  
    <tr> 
        <td align="left" valign="middle"><strong>{L_INDEX}</strong><br />{SEARCH_INFO}</td>
...
{OPEN_TABLE}
<table width="100%" cellspacing="2" cellpadding="2">
    <tr><td align="left"><strong>{L_INDEX}</strong></td><td><div style='float: right;'>{PAGINATION}</div></td></tr>
    <tr><td align="left" colspan="2">{PAGE_NUMBER}</td></tr>
</table>
{CLOSE_TABLE}
{OPEN_TABLE}
