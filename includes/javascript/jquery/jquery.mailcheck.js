...
(function($){
  $.fn.mailcheck = function(opts, optsAlt) {
    var defaultDomains = ["yahoo.com", "google.com", "hotmail.com", "gmail.com", "me.com", "aol.com", "mac.com",
                          ...
                          "facebook.com", "verizon.net", "sbcglobal.net", "att.net", "gmx.com", "mail.com", "yandex.ru",
                          "ukr.net","rambler.ru"];
    var defaultTopLevelDomains = ["co.uk", "com", "net", "org", "info", "edu", "gov", "mil", "ua", "ru"];
    ...
    var result = Kicksend.mailcheck.suggest(this.val(), opts.domains, opts.topLevelDomains, opts.distanceFunction);
    if (result) {
      if (opts.suggested) {
